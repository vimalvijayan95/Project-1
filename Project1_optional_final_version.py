...
def plot(x, y, z):
    ...
    surf = ax.plot_surface(
        x, y, z.reshape(*x.shape), cmap=cm.gray, linewidth=0.1
    )
    ...
    ax.set_title("Madrid terrain (training)")
...
#for plots
xnew, ynew = np.meshgrid(xtrain, ytrain)
...
print("\nOrdinary Least Squares with %s-fold Cross-Validation:"
    % str(k))
